...
const ContactMe = () => {
  ...
  return (
    ...
    <div className="max-w-md mt-10 mx-auto mb-24 bg-neutral-900 p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <center><button className="bg-gradient-to-r  from-pink-300 via-slate-500 to-purple-600 py-4 w-30 lg:w-40 text-neutral-950 font-bold rounded-lg mt-7" type="submit">
              Send
            </button></center>
