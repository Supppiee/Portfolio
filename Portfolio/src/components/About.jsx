...
const About = () => {
  return (
    <div className="border-b border-neutral-900 pb-79 lg:pl-14">
      ...
      <div className="flex flex-wrap  ">
        ...
        <div className="w-full lg:w-1/2 mt-10 lg:pl-14">
          <div className="flex justify-center flex-col  lg:justify-start">
            ...
            <button className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-600 py-4 w-30 lg:w-40 text-neutral-950 font-bold rounded-lg mt-7 ">
              Download CV
            </button>
            </a>
